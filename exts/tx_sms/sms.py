...
class SmsSingleSender:
    ...
    def send_with_param(self, nation_code, phone_number, temp_id, params, sign, extend, ext):
        """ 指定模板单发
...
class SmsMultiSender:
    ...
    def send_with_param(self, nation_code, phone_numbers, temp_id, params, sign, extend, ext):
        """ 指定模板群发
        【注意】海外短信没有群发功能
